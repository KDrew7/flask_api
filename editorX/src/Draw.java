...
public class Draw {
	...
	JButton clearButton, blackButton, blueButton, greenButton, redButton,
			...
			whiteButton, cyanButton, eraser, saveButton, loadButton,
			saveAsButton, rectangle, pencil, undoButton, redoButton;
	private JFileChooser fileChooser;
	private File file;
	private Icon save = new ImageIcon(getClass().getResource("bin/save.png"));
	private Icon undo = new ImageIcon(getClass().getResource("bin/undo.png"));
	private Icon redo = new ImageIcon(getClass().getResource("bin/redo.png"));
	private Icon pencilIcon = new ImageIcon(getClass()
			.getResource("bin/pencil.png"));
	private Icon rect = new ImageIcon(getClass().getResource("bin/rect.png"));
	...
	ActionListener listener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent event) {
			if (event.getSource() != eraser) {
				canvas.g.setComposite(AlphaComposite.Src);
